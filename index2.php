...
<div class="container-fluid gral">
	<header><div class="container" style="display: none">
	...
	<section>
<?php
if(isset($_POST['porque2'])):
		$msj='<h2><i class="fa fa-futbol-o" aria-hidden="true"></i> Gracias por tu inscripción! Pronto informaremos sobre los seleccionados</h2>
		...
		if (mysqli_connect_errno()):
			...
			if ($insert = $mysqli->prepare("INSERT INTO formulario (nombre,ciudad,correo,rut,juegas,nacimiento,porque2) VALUES (?,?,?,?,?,?,?)")) :
				...
				$insert->bind_param("sssssss", $nombre, $ciudad, $correo, $rut, $juegas, $nacimiento, $porque2);
...
<?php else: ?>
		<form action="index2.php" enctype="application/x-www-form-urlencoded" method="post" class="container">
			<h3>Inscribete acá</h3>
			...
			<textarea class="form-control" rows="3" name="porque2" placeholder="¿Por qué quieres jugar por la U?" required></textarea>
			<button type="submit" class="btn btn-red">Enviar</button>
		</form>
<?php endif; ?>
	</section>
	<footer><div class="container" style="display: none">
